 ...
 //console.log("AllDataObjects : ", allDataObjects)
  ...
  const getValueAndParams = async (objs) => {
    ...
    for (const obj of objs) {
      ...
      //console.log("params : ", params, "et values : ",values)
        ...
        <div id="user">
          {!token ? (
            ...
            <div id="connectedSection" className="d-flex flex-column justify-content-center align-items-center text-center py-4 px-3 shadow-sm rounded mt-2">
              ...
              <a href="/user" className="btn btn-link mb-3 text-decoration-none fs-5 hover-shadow colortext">
                <span className="material-symbols-rounded me-2 align-middle">settings</span> Account Settings
              </a>
              <button
                className="btn btn-outline-danger d-flex align-items-center gap-2 py-2 px-4 fs-5 btn-with-glow-effect"
